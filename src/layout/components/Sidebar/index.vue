  ...
  <div class="sidebar-container">
    <div class="logo" @click="$router.push('/')">
      <transition name="el-zoom-in-center">
        <h1 v-show="opened" class="logo-text">后台管理系统</h1>
      </transition>
    </div>
    <el-scrollbar wrap-class="scrollbar-wrapper">
      <el-menu :router="true" :default-active="$route.path" :collapse="isCollapse" :show-timeout="200" :unique-opened="true" text-color="#fff" background-color="#4a5a74" active-text-color="#409EFF">
...
// import logoSrc from '@/assets/images/footer_logo.png'
